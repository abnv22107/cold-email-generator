...
class Chain:
    ...
    def write_email(self, job_description, portfolio_urls):
        prompt_email = PromptTemplate.from_template(
                ...
                Your Role: Your name is Abhinav,Your email is abhinav123@gmail.com, Your phone no is +123 456 You are an incredible business development officer who knows how to get clients. You work for Mentee Consulting firm, your firm works with all sorts of IT clients and provide solutions in the domain of Data Science and AI. 
